...
var App = (function() {
    ...
    if ($mode === "init") {
      ...
      jQuery('[data-toggle="block-option"][data-action="content_toggle"]').each(
        function() {
          ...
          $this.html(
            '<i class="' +
              ($this.closest(".block").hasClass("block-opt-hidden")
                ? $iconContentActive
                : $iconContent) +
              '"></i>'
          );
      ...
      if ($elBlock.length) {
        ...
        switch ($mode) {
          case "fullscreen_toggle":
            ...
            $elBlock.hasClass("block-opt-fullscreen")
          ...
          case "refresh_toggle":
            ...
            if (
              jQuery(
                '[data-toggle="block-option"][data-action="refresh_toggle"][data-action-mode="demo"]',
                $elBlock
              ).length
            ) {
              setTimeout(function() {
  ...
  var uiHandleTheme = function() {
    ...
    if ($cookies) {
      var $theme = Cookies.get("colorTheme")
        ...
        if ($theme === "default") {
          ...
          if ($cssTheme.length) {
            ...
            jQuery("#css-main").after(
              '<link rel="stylesheet" id="css-theme" href="' + $theme + '">'
            );
          }
        }
      }
    ...
    jQuery(
      '[data-toggle="theme"][data-theme="' +
        ($cssTheme.length ? $cssTheme.attr("href") : "default") +
        '"]'
    )
      .parent("li")
      .addClass("active");
  ...
  var uiHelperSlimscroll = function() {
    ...
    jQuery('[data-toggle="slimscroll"]').each(function() {
      ...
      var $rcolor = $this.data("rail-color")
        ? $this.data("rail-color")
        : "#999";
      var $ropacity = $this.data("rail-opacity")
        ? $this.data("rail-opacity")
        : 0.3;
  ...
  var uiHelperSlick = function() {
    ...
    jQuery(".js-slider").each(function() {
      ...
      var $sliderArrows = $slider.data("slider-arrows")
        ? $slider.data("slider-arrows")
        : false;
      var $sliderDots = $slider.data("slider-dots")
        ? $slider.data("slider-dots")
        : false;
      var $sliderNum = $slider.data("slider-num")
        ? $slider.data("slider-num")
        : 1;
      var $sliderAuto = $slider.data("slider-autoplay")
        ? $slider.data("slider-autoplay")
        : false;
      var $sliderAutoSpeed = $slider.data("slider-autoplay-speed")
        ? $slider.data("slider-autoplay-speed")
        : 3000;
  ...
  var uiHelperNotify = function() {
    ...
    jQuery(".js-notify").on("click", function() {
      ...
      var $notifyType = $notify.data("notify-type")
        ? $notify.data("notify-type")
        : "info";
      var $notifyFrom = $notify.data("notify-from")
        ? $notify.data("notify-from")
        : "top";
      var $notifyAlign = $notify.data("notify-align")
        ? $notify.data("notify-align")
        : "right";
      var $notifyIcon = $notify.data("notify-icon")
        ? $notify.data("notify-icon")
        : "";
      var $notifyUrl = $notify.data("notify-url")
        ? $notify.data("notify-url")
        : "";
  ...
  var uiHelperMaxlength = function() {
    ...
    jQuery(".js-maxlength").each(function() {
      ...
      $input.maxlength({
        ...
        warningClass: $input.data("warning-class")
          ? $input.data("warning-class")
          : "label label-warning",
        limitReachedClass: $input.data("limit-reached-class")
          ? $input.data("limit-reached-class")
          : "label label-danger",
